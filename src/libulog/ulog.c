...
static const char *level_strings[] = {
        ...
        "T", "D", "I", "W", "E", "F"
#else
        "TRACE", "DEBUG", "INFO", "WARN", "ERROR", "FATAL", "GAME"
#endif
};
...
static void callback_stdout(ulog_Event *ev, void *arg) {
    ...
    bool endWithNewLine = (len > 0 && (ev->message[len - 1] == '\n' || ev->message[len - 1] == '\r'));
    write_formatted_message(ev, fp, ULOG_TIME_SHORT, ULOG_COLOR_ON, !endWithNewLine);
}
